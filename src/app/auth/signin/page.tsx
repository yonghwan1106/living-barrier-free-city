      ...
      <Card className="w-full max-w-md p-8 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            disabled
            className="w-full h-12 text-base font-medium bg-[#FEE500] text-[#000000] hover:bg-[#FDD835] disabled:opacity-50"
          >
          ...
          <Button
            ...
            disabled
            className="w-full h-12 text-base font-medium bg-[#03C75A] text-white hover:bg-[#02B350] disabled:opacity-50"
          >
            <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
